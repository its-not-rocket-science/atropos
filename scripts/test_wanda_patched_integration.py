#!/usr/bin/env python3
"""Integration test for WandaPatchedFramework."""
...
def test_framework_availability():
    ...
    print("Testing WandaPatchedFramework availability...")
    try:
        framework = get_pruning_framework("wanda-patched")
...
if __name__ == "__main__":
    print("=" * 60)
    print("WandaPatchedFramework Integration Test")
    print("=" * 60)
